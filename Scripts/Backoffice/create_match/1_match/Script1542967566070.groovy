...
WebUI.verifyElementPresent(findTestObject('Backoffice/match_mgmt/button_create_match'), 0)
...
WebUI.setText(findTestObject('Backoffice/match_mgmt/input__select2-search__arena_name'), Arena_Name)
