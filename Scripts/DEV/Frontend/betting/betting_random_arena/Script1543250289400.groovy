...
arenaPresent = WebUI.verifyElementPresent(findTestObject('Frontend/Betting/i_arena_button'), 1)

matchPresent = WebUI.verifyElementPresent(findTestObject('Frontend/Betting/Bet Amount Field/input_bet_amount_field'), 1, FailureHandling.OPTIONAL)
...
if (((balance > 100) && arenaPresent) && matchPresent) {
    ...
    for (i = 1; i < 5; i++) {
        WebElement button = driver.findElement(By.xpath('//*[@id="betslip-b72aa2a2-ca07-493a-b359-78971ebeb395-container"]/div[1]/div['+i+']'))
    ...
    WebUI.click(findTestObject('Frontend/Betting/i_arena_button'))
